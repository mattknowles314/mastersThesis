...
In this chapter, we outline the background behind this project. Looking into why the topic is one of relevancy, and why it is worth looking at. This comes after an introduction to cricket itself,
the sports-inclined reader may still find this of use, as it talks about the specific aspects of the game that will be most important in the remainder of the project. The issues raised by the current methods 
