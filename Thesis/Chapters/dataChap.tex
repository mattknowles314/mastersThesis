...
In order to clean data and make it usable, the Python programming language was used to take the original JSON files and turn them into CSV files on which analysis could 
