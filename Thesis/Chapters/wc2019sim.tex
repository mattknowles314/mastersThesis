...
For a general example of how this method works, we refer the reader back to Example~\ref{redEx}.
...
It is worth mentioning that on average, this model had a tendency to predict a higher score by an average of 58.22 runs. This could perhaps be taken into account by reducing the target set by this or a similar 
amount. 