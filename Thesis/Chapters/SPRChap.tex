...
\begin{figure}[h] %MAKE SURE THESE ARE THE RIGHT LINES OF CODE!!
    \lstinputlisting[language=R, firstline=11,lastline=12]{../code/scoreNet.R}
...
was found to have a median time complexity of $\mathcal{O}(N^4)$ in \cite{lister}. So given that we have a relatively small dataset, we can definatively