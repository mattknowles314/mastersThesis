...
Up until an error of around 2, we see this was more normally distributed than the original predictions. This is promising, but the imporant thing is how far 
