...
We can see in Figure~\ref{diffbox}, that the difference is mostly centered around 0, which is promising, but clearly the corrolations are all off. At present, the scores are all values between 
-3 and 3, which is due to scalling. So to get a true intuitive idea of how these models have performed, we must unscale the data. 
